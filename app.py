...
Original file is located at
    https://colab.research.google.com/drive/1J_qvdmBR6sZZFkrOlMHFDdKA8T_vXorQ
"""
...
with col1:
  ...
  st.metric(label="Total Downtime 2025", value="672 Menit", delta="-672 Menit (2026)")
  st.metric(label="Status Operasional 2026", value="Optimal / Zero Failure", delta="Normal")

with col2:
  st.subheader("📈 Grafik Tren Kejadian Gangguan (2021 - 2026)")

  # Membuat Dual-Axis Chart menggunakan Plotly agar lebih interaktif dan profesional
  fig = go.Figure()
  ...
  # Menambahkan Anotasi Sorotan (Highlight) seperti pada gambar
  fig.add_annotation(
      x=2021,
      y=685,
